    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-hitman-800/50 to-hitman-900/50 backdrop-blur-sm border border-hitman-700 rounded-xl p-6 hover:border-accent-red/50 transition-all">
          ...
          <div className="mt-2 text-sm text-hitman-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-accent-blue">{systemStats?.averageLevel || 1}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-hitman-300 flex items-center gap-2">
              ...
              <span className="font-bold">{(systemStats?.totalCharacters || 0).toLocaleString()}</span>
            </div>
                         <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-accent-green">{activePercentage}%</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-accent-yellow">{systemStats?.maxLevel || 1}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-sm">{new Date().toLocaleTimeString('ar-SA')}</span>
             </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-accent-green">مستقر</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-accent-green">${(systemStats?.totalMoney || 0).toLocaleString()}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-hitman-300 flex items-center gap-2">
              ...
              <span className="font-bold text-accent-yellow">{(systemStats?.totalBlackcoins || 0).toLocaleString()}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-hitman-300 flex items-center gap-2">
              ...
              <span className="font-bold">${averageMoney.toLocaleString()}</span>
            </div>
                         <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold">{averageBlackcoins.toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
                 <Award className="w-4 h-4" />
               ...
               <span className="font-bold">{averageExperience.toLocaleString()}</span>
             </div>
          </div>
        </div>
      </div>
         ...
         <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
           ...
           <div className="space-y-4">
             <div className="flex justify-between items-center">
               ...
               <span className="font-bold text-accent-blue">{(systemStats?.totalFights || 0).toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-accent-red">{(systemStats?.totalCrimes || 0).toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-pink-400">{(systemStats?.totalContracts || 0).toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-indigo-400">{(systemStats?.totalMissions || 0).toLocaleString()}</span>
             </div>
           </div>
         </div>
         ...
         <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
           ...
           <div className="space-y-4">
             <div className="flex justify-between items-center">
               ...
               <span className="font-bold text-accent-green">{(systemStats?.totalCars || 0).toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-accent-yellow">{(systemStats?.totalDogs || 0).toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-purple-400">{(systemStats?.totalContracts || 0).toLocaleString()}</span>
             </div>
             <div className="flex justify-between items-center">
               <span className="text-hitman-300 flex items-center gap-2">
               ...
               <span className="font-bold text-red-400">{(systemStats?.totalMissions || 0).toLocaleString()}</span>
             </div>
           </div>
         </div>
       </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-blue/50 transition-all">
          ...
          <h4 className="font-bold text-accent-blue">المعارك</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-red/50 transition-all">
          ...
          <h4 className="font-bold text-accent-red">الجرائم</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-green/50 transition-all">
          ...
          <h4 className="font-bold text-accent-green">المنازل</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-yellow/50 transition-all">
          ...
          <h4 className="font-bold text-accent-yellow">السيارات</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-purple/50 transition-all">
          ...
          <h4 className="font-bold text-purple-400">الكلاب</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-orange/50 transition-all">
          ...
          <h4 className="font-bold text-orange-400">العناصر الخاصة</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-pink/50 transition-all">
          ...
          <h4 className="font-bold text-pink-400">العصابات</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/20 to-hitman-900/20 backdrop-blur-sm border border-hitman-700 rounded-lg p-4 text-center hover:border-accent-indigo/50 transition-all">
          ...
          <h4 className="font-bold text-indigo-400">المهام</h4>
          <p className="text-sm text-hitman-400">نشط</p>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-green-900/20 border border-green-500/30 rounded-lg">
              ...
              <span className="text-green-400 font-bold">مستقر</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
              ...
              <span className="text-yellow-400 font-bold">جيد</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-hitman-800/30 to-hitman-900/30 backdrop-blur-sm border border-hitman-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
              <h4 className="font-bold text-yellow-400 mb-2">نصائح للمشرف</h4>
